...
public class CollectionsEx1 {
    public static void main(String[] args) {
        ...
        System.out.println("월은 몇 번째 날: " + c1.get(Calendar.DAY_OF_MONTH));
        System.out.println("요일의 몇 번째 날: " + c1.get(Calendar.DAY_OF_YEAR));
        ...
        System.out.println(sdf.format("현재시간"+ c1.getTime()));
        c1.clear();
        System.out.println("claer : "+sdf.format(c1.getTime()));
        c1.set(2028,10, 25, 15, 28, 38);
        System.out.println("값 설정"+sdf.format(c1.getTime()));

        // 각 필요한 필드 설정
        System.out.println();
        System.out.println("====[각 필요한 필드 설정]====");
        ...
        //현재와 본인 생년 월일
        System.out.println();
        System.out.println("====[현재와 본인 생년 월일]====");
        Calendar now = Calendar.getInstance();
        Calendar birth = Calendar.getInstance();
        birth.clear();
        birth.set(1992,8,10,15,28,30);
